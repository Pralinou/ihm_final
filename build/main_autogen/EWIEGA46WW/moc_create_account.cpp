/****************************************************************************
** Meta object code from reading C++ file 'create_account.hpp'
**
...
#error "The header file 'create_account.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 20), // "createAccountClicked"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "CreateAccount\0createAccountClicked\0"
};
...
void CreateAccount::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->createAccountClicked(); break;
        default: ;
        }
    }
    (void)_a;
